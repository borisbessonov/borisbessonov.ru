...
const PARTICLE_SETTINGS = {
  ...
  size: 0.03,           // Размер частиц
  speed: 0.005,         // Скорость движения
  spawnArea: 0.5        // Область появления вокруг модели (0-1)
};
...
const SCROLL_SETTINGS = {
  minDistance: 1.5,    // Минимальное расстояние камеры
  maxDistance: 3.0,    // Максимальное расстояние камеры
  sensitivity: 0.001   // Чувствительность скролла
};
